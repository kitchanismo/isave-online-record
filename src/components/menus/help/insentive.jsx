		...
		<div className='card mb-1' style={{width: 'auto'}}>
			<div className='card-body'>
				<div className='d-flex justify-content-between'>
					<h4 className='card-title'>Sales Performance Insentive Funds</h4>
					<a
				...
				>
					...
					{instruction({
						question: 'How to add an insentive?',
						steps: [
							...
							'Click post to select from list the desire employee to have an insentive.',
							'Enter the prize rewards of employee.'
						]
					})}
					{instruction({
						question: 'How to delete an insentive?',
						steps: [
